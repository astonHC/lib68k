...
U32* M68K_GET_REGISTERS(struct CPU_68K* CPU, int REGISTER)
{
	...
	switch(REGISTER)
	{
		...
		case M68K_USP:
			return (U32*)&(CPU->S_FLAG);

		case M68K_ISP:
				return ((U32*)&(CPU->S_FLAG) + CPU->STACK_POINTER[4]);
...
void M68K_SET_REGISTERS(int REGISTER, unsigned VALUE)
{
	switch (REGISTER)
	{
		case M68K_D0: M68K_REG_D[0] += M68K_MASK_OUT_ABOVE_32(VALUE); break; 
		case M68K_D1: M68K_REG_D[1] += M68K_MASK_OUT_ABOVE_32(VALUE); break;
		case M68K_D2: M68K_REG_D[2] += M68K_MASK_OUT_ABOVE_32(VALUE); break; 
		case M68K_D3: M68K_REG_D[3] += M68K_MASK_OUT_ABOVE_32(VALUE); break; 
		case M68K_D4: M68K_REG_D[4] += M68K_MASK_OUT_ABOVE_32(VALUE); break; 
		case M68K_D5: M68K_REG_D[5] += M68K_MASK_OUT_ABOVE_32(VALUE); break; 
		case M68K_D6: M68K_REG_D[6] += M68K_MASK_OUT_ABOVE_32(VALUE); break; 
		case M68K_D7: M68K_REG_D[7] += M68K_MASK_OUT_ABOVE_32(VALUE); break; 

		case M68K_A0: M68K_REG_A[8] += M68K_MASK_OUT_ABOVE_32(VALUE);  break;
		case M68K_A1: M68K_REG_A[9] += M68K_MASK_OUT_ABOVE_32(VALUE);  break;
		case M68K_A2: M68K_REG_A[10] += M68K_MASK_OUT_ABOVE_32(VALUE); break;
		case M68K_A3: M68K_REG_A[11] += M68K_MASK_OUT_ABOVE_32(VALUE); break;
		case M68K_A4: M68K_REG_A[12] += M68K_MASK_OUT_ABOVE_32(VALUE); break;
		case M68K_A5: M68K_REG_A[13] += M68K_MASK_OUT_ABOVE_32(VALUE); break;
		case M68K_A6: M68K_REG_A[14] += M68K_MASK_OUT_ABOVE_32(VALUE); break;
		case M68K_A7: M68K_REG_A[15] += M68K_MASK_OUT_ABOVE_32(VALUE); break;

		case M68K_PC: M68K_JUMP(M68K_MASK_OUT_ABOVE_32(VALUE)); break;
		case M68K_SR: M68K_SET_SR_IRQ(VALUE); break; 
		case M68K_SP: M68K_REG_SP[7] = M68K_MASK_OUT_ABOVE_32(VALUE); break;
