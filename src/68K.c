...
void M68K_SET_REGISTERS(CPU_68K_REGS REGISTER, unsigned VALUE)
{
	switch (REGISTER)
	{
		case M68K_D0: M68K_REG_BASE[0] += M68K_MASK_OUT_ABOVE_32(VALUE); return;
		case M68K_D1: M68K_REG_BASE[1] += M68K_MASK_OUT_ABOVE_32(VALUE); return;
		case M68K_D2: M68K_REG_BASE[2] += M68K_MASK_OUT_ABOVE_32(VALUE); return;
		case M68K_D3: M68K_REG_BASE[3] += M68K_MASK_OUT_ABOVE_32(VALUE); return;
		case M68K_D4: M68K_REG_BASE[4] += M68K_MASK_OUT_ABOVE_32(VALUE); return;
		case M68K_D5: M68K_REG_BASE[5] += M68K_MASK_OUT_ABOVE_32(VALUE); return;
		case M68K_D6: M68K_REG_BASE[6] += M68K_MASK_OUT_ABOVE_32(VALUE); return;
		case M68K_D7: M68K_REG_BASE[7] += M68K_MASK_OUT_ABOVE_32(VALUE); return;

		case M68K_A0: M68K_REG_BASE[8] += M68K_MASK_OUT_ABOVE_32(VALUE); return;
		case M68K_A1: M68K_REG_BASE[9] += M68K_MASK_OUT_ABOVE_32(VALUE); return;
		case M68K_A2: M68K_REG_BASE[10] += M68K_MASK_OUT_ABOVE_32(VALUE); return;
		case M68K_A3: M68K_REG_BASE[11] += M68K_MASK_OUT_ABOVE_32(VALUE); return;
		case M68K_A4: M68K_REG_BASE[12] += M68K_MASK_OUT_ABOVE_32(VALUE); return;
		case M68K_A5: M68K_REG_BASE[13] += M68K_MASK_OUT_ABOVE_32(VALUE); return;
		case M68K_A6: M68K_REG_BASE[14] += M68K_MASK_OUT_ABOVE_32(VALUE); return;
		case M68K_A7: M68K_REG_BASE[15] += M68K_MASK_OUT_ABOVE_32(VALUE); return;

		case M68K_PC: M68K_JUMP(M68K_MASK_OUT_ABOVE_32(VALUE)); return;
		case M68K_SR: M68K_SET_SR_IRQ(VALUE); return;
		case M68K_SP: M68K_REG_SP[7] = M68K_MASK_OUT_ABOVE_32(VALUE); return;

		case M68K_USP: 
				if(FLAG_S) M68K_REG_USP += *(U32*)M68K_MASK_OUT_ABOVE_32(VALUE);
					else
		...
		case M68K_ISP:
				...
				M68K_REG_ISP += *(U32*)M68K_MASK_OUT_ABOVE_32(VALUE);
					return;

		default:
			fprintf(stderr, "Error: Invalid REGISTER value: %d\n", REGISTER);
			exit(1);
	}
}
